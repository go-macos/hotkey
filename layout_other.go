...
// platformChar has no keyboard layout service to ask here, so it answers
// nothing and every caller falls back to the ANSI name.
//
...
func platformChar(Key) string { return "" }
